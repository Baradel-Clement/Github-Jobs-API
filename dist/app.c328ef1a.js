...
var para = document.querySelector('.filter-fulltime > p');
var searchButton = document.querySelector('.search-button');
var filterLocation = document.querySelector('.filter-location');
var mobileSearchBtn = document.querySelector('.search-button-wrapper-mobile');
var filterFulltime = document.querySelector('.filter-fulltime');
...
if (window.matchMedia("(max-width: 768px)").matches && window.matchMedia("(min-width: 1px)").matches) {
...
function shortCompanyUrl(url) {
  if (!url || url == 'http:' || !url.includes('.') || url == 'http://http') {
    ...
    var indexStartUrl = url.indexOf('//') + 2;
...
function displayJobs(jobs, reset, inputObject) {
  ...
  jobs.forEach(function (job) {
    ...
    var newJobCreatedAt = job.created_at.slice(0, 16);
    /* newJob.setAttribute('onclick', 'onClickJob(this)'); */

    newJob.addEventListener('click', function (e) {
      onClickJob(e.target.closest(".job"));
    });
    newJob.innerHTML = "\n        <div class=\"job-card\">\n                <img class=\"job-card-logo\" src=\"".concat(checkCompanyLogo(job.company_logo), "\" alt=\"logo\">\n                <p class=\"dark-grey job-card-desc\">").concat(newJobCreatedAt, "<span class=\"dark-grey job-circle\">  .  </span>").concat(job.type, "</p>\n                <p class=\"job-card-title header-color\">").concat(job.title, "</p>\n                <p class=\"dark-grey job-card-desc\">").concat(job.company, "</p>\n                <p class=\"violet job-card-location\">").concat(job.location, "</p>\n            </div>\n        <div class=\"job-detail\">\n            <div class=\"job-detail-header\">\n                <img src=\"").concat(checkCompanyLogo(job.company_logo), "\" alt=\"detail-logo\">\n                <div class=\"job-detail-header-desc\">\n                    <div>\n                        <p class=\"job-detail-header-title header-color\">").concat(job.company, "</p>\n                        <p class=\"job-card-desc dark-grey\">").concat(shortCompanyUrl(job.company_url), "</p>\n                    </div>\n                    <a href=\"").concat(checkCompanyUrl(job.company_url), "\" target=\"_blank\" class=\"company-button\">Company site</a>\n                    <p class=\"error\">No company site</p>\n                </div>\n            </div>\n            <div class=\"job-detail-desc\">\n                <a href=\"").concat(checkCompanyUrl(job.company_url), "\" target=\"_blank\" class=\"apply-button-desc apply-button button\">Apply Now</a>\n                <p class=\"dark-grey job-card-desc\">").concat(newJobCreatedAt, " <span class=\"dark-grey job-circle\">  .  </span> ").concat(job.type, "</p>\n                <p class=\"job-detail-desc-title\">").concat(job.title, "</p>\n                <p class=\"violet job-card-location\">").concat(job.location, "</p>\n                ").concat(job.description, "\n            </div>\n            <div class=\"job-detail-apply\">\n                <p class=\"color-header px20\">How to apply</p>\n                ").concat(job.how_to_apply, "\n            </div>\n            <div class=\"job-detail-footer\">\n                <div class=\"job-detail-footer-wrap\">\n                    <p class=\"px20 color-header detail-footer-header\">").concat(job.title, "</p>\n                    <p class=\"dark-grey job-card-desc\">").concat(job.company, "</p>\n                    <a href=\"").concat(job.url, "\" target=\"_blank\" class=\"apply-button-footer apply-button button\">Apply Now</a>\n                </div>\n            </div>\n        </div>\n        "); // if no company url provided display error btn

    if (companyButtonError) {
      var companyButtonErrorPara = newJob.lastElementChild.firstElementChild.lastElementChild.lastElementChild;
      var companyButtonBtn = companyButtonErrorPara.previousElementSibling;
  ...
  if (jobs.length == 0) {
    ...
    var errorParagraph = errorDisplay.lastElementChild;
    ...
    errorParagraph.innerHTML = "No <span class=\"header-color\">".concat(inputObject.fulltime, "</span> <span class=\"header-color\">").concat(inputObject.search, "</span> jobs found in <span class=\"header-color\">").concat(inputObject.location, "</span>");
  } else {
...
function getInputValues(button) {
  ...
  var location = document.querySelector('#search-location').value;
  var fulltime = document.querySelector('#check').checked;
...
var getJobs = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(inputObject) {
    var proxy, url, reset, response, jobs;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "https://jobs.github.com/positions.json?description=".concat(inputObject.search, "&location=").concat(inputObject.location, "&full_time=").concat(inputObject.fulltime, "&page=").concat(page); // site that doesn’t send Access-Control-*
            ...
            console.log(url);
            _axios.default.defaults.headers.post['Access-Control-Allow-Origin'] = '*';
            _context.next = 8;
            return _axios.default.get(proxy + url);
          ...
          case 15:
            ...
            console.error('les erreurs:' + _context.t0);
...
function onClickJob(job) {
  var allJob = document.querySelectorAll('.job');

  if (!job.classList.contains('job-detail-on')) {
    allJob.forEach(function (element) {
      return element.classList.toggle('job-detail-out');
    });
...
function removeDetailDisplay() {
  var currentDetailJob = document.querySelector('.job.job-detail-on');
  var allJob = document.querySelectorAll('.job');
  allJob.forEach(function (element) {
    return element.classList.remove('job-detail-out');
  });
...
document.querySelector("#header-img").addEventListener("click", removeDetailDisplay);
switcher.addEventListener("click", togglingDarkMode);
document.querySelector("#icon-filter").addEventListener("click", togglingFilterSearch);
document.getElementById('searchBtnDesktop').addEventListener('click', function () {
  getInputValues(document.getElementById('searchBtnDesktop'));
});
document.getElementById('searchBtnMobile').addEventListener('click', function () {
  getInputValues(document.getElementById('searchBtnMobile'));
});
document.getElementById('loadMoreBtn').addEventListener('click', function () {
  getInputValues(document.getElementById('loadMoreBtn'));
});
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js"}],"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
